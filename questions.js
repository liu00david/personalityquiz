...
const questions = [
  ...
  { text: "I’m attracted to lots of physical types.", weights: [0, -1, 0, 0] },
  ...
  { text: "In arguments, there's usually a clear right and wrong.", weights: [0, 0, 0, -0.75] },
  { text: "I try to interpret the meaning behind someone's actions.", weights: [0.5, 0, 0, -0.75] },
  { text: "I'm usually the one to apologize first.", weights: [0, 0, 0, 1.25] },
  { text: "When I'm frustrated, my voice or tone easily changes.", weights: [0, 0, 0, -1] },
