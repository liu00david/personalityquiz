...
const questions = [
  ...
  { text: "When developing feelings for someone, I sometimes forget to think rationally", dimension: "IR", direction: "I" },
  ...
  { text: "When evaluating a relationship, I focus on patterns of behavior rather than isolated moments", dimension: "IR", direction: "R" },
  { text: "I have to check compatibility boxes before persuing someone", dimension: "IR", direction: "R" },
  { text: "I prefer discussing relationship milestones and timelines", dimension: "IR", direction: "R" },
  { text: "I have a solid idea for my wedding regardless of who my partner is", dimension: "IR", direction: "I" },
  ...
  { text: "After a long day apart, I want to just relax without much talking", dimension: "PE", direction: "P" },
  { text: "I feel most understood when my partner asks about my feelings towards things", dimension: "PE", direction: "E" },
  ...
  { text: "I prefer to list gifts for my partner rather than being surprised", dimension: "PE", direction: "P" },
  { text: "I feel disconnected if we're physically intimate but not emotionally vulnerable", dimension: "PE", direction: "E" },
  { text: "My partner de-stresses me by being present rather than talking", dimension: "PE", direction: "P" },
