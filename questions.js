...
const questions = [
  ...
  { text: "I need a defined relationship to be intimate with someone.", weights: [-0.5, -1.5, 0, 0] },
  ...
  { text: "I try to include my partner in my friend group plans.", weights: [0, 0, 0.75, 0] },
  ...
  { text: "I often compare my dating life to other people.", weights: [0.5, 0, 1, 0] },
  ...
  { text: "During arguments, there's usually a clear right and wrong.", weights: [0, 0, 0, -0.75] },
  { text: "I look for the deeper meaning behind someone's actions.", weights: [0.5, -0.5, 0, -0.75] },
  { text: "I'm usually the one to apologize first.", weights: [0, 0, 0, 1.25] },
