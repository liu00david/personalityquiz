...
const questions = [
  ...
  { text: "When looking to date, it's important to keep my options open.", dimension: "IR", direction: "I" },
  ...
  { text: "I believe that soulmates exist.", dimension: "IR", direction: "I" },
  { text: "I believe that sometimes we meet the right person at the wrong time.", dimension: "IR", direction: "I" },
  ...
  { text: "It's possible to see past flaws if someone is really attractive.", dimension: "PE", direction: "P" },
  { text: "I can easily get the ick from how someone behaves.", dimension: "PE", direction: "P" },
  { text: "The setting of my first kiss with someone matters a lot.", dimension: "PE", direction: "E" },
  ...
  { text: "I enjoy discussing important and interesting topics with my partner.", dimension: "PE", direction: "E" },
  { text: "I sometimes inconvenience myself to help strangers.", dimension: "PE", direction: "E" },
  { text: "I only develop feelings for someone if I am sure about our compatibility.", dimension: "PE", direction: "E" },
  ...
  { text: "I would be comfortable with PDA.", dimension: "SV", direction: "S" },
  ...
  { text: "I often need time alone without my partner.", dimension: "SV", direction: "S" },
  ...
  { text: "There is always a right and wrong during arguments.", dimension: "FC", direction: "C" },
  { text: "If someone apologies to me, I wonder if they're actually sorry.", dimension: "FC", direction: "C" },
  ...
  { text: "It's easy for me to understand people's motivations.", dimension: "FC", direction: "F" },
